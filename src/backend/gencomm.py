...
type_ops = {'_Bool': {'REPLACE', 'LAND', 'LOR', 'LXOR'},
            'char': {'REPLACE'},
            'wchar_t': {'REPLACE'},
            'short' : {'REPLACE', 'SUM', 'PROD', 'MIN', 'MAX', 'LAND', 'LOR', 'LXOR', 'BAND', 'BOR', 'BXOR'},
            'int'   : {'REPLACE', 'SUM', 'PROD', 'MIN', 'MAX', 'LAND', 'LOR', 'LXOR', 'BAND', 'BOR', 'BXOR'},
            'long'  : {'REPLACE', 'SUM', 'PROD', 'MIN', 'MAX', 'LAND', 'LOR', 'LXOR', 'BAND', 'BOR', 'BXOR'},
